...
file_server2__srv__GetBinaryFile_Request__init(file_server2__srv__GetBinaryFile_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->name)) {
    file_server2__srv__GetBinaryFile_Request__fini(msg);
    return false;
  }
  return true;
}
...
file_server2__srv__GetBinaryFile_Request__create(void)
{
  ...
  file_server2__srv__GetBinaryFile_Request * msg = (file_server2__srv__GetBinaryFile_Request *)allocator.allocate(sizeof(file_server2__srv__GetBinaryFile_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(file_server2__srv__GetBinaryFile_Request));
  bool success = file_server2__srv__GetBinaryFile_Request__init(msg);
  if (!success) {
...
file_server2__srv__GetBinaryFile_Request__Sequence__init(file_server2__srv__GetBinaryFile_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  file_server2__srv__GetBinaryFile_Request * data = NULL;

  if (size) {
    data = (file_server2__srv__GetBinaryFile_Request *)allocator.zero_allocate(size, sizeof(file_server2__srv__GetBinaryFile_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = file_server2__srv__GetBinaryFile_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        file_server2__srv__GetBinaryFile_Request__fini(&data[i - 1]);
      }
...
file_server2__srv__GetBinaryFile_Request__Sequence__fini(file_server2__srv__GetBinaryFile_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      file_server2__srv__GetBinaryFile_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  file_server2__srv__GetBinaryFile_Request__Sequence * array = (file_server2__srv__GetBinaryFile_Request__Sequence *)allocator.allocate(sizeof(file_server2__srv__GetBinaryFile_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = file_server2__srv__GetBinaryFile_Request__Sequence__init(array, size);
  if (!success) {
...
file_server2__srv__GetBinaryFile_Request__Sequence__destroy(file_server2__srv__GetBinaryFile_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    file_server2__srv__GetBinaryFile_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
file_server2__srv__GetBinaryFile_Request__Sequence__are_equal(const file_server2__srv__GetBinaryFile_Request__Sequence * lhs, const file_server2__srv__GetBinaryFile_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!file_server2__srv__GetBinaryFile_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  file_server2__srv__GetBinaryFile_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(file_server2__srv__GetBinaryFile_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    file_server2__srv__GetBinaryFile_Request * data =
      (file_server2__srv__GetBinaryFile_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!file_server2__srv__GetBinaryFile_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          file_server2__srv__GetBinaryFile_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!file_server2__srv__GetBinaryFile_Request__copy(
...
file_server2__srv__GetBinaryFile_Response__init(file_server2__srv__GetBinaryFile_Response * msg)
{
  ...
  if (!rosidl_runtime_c__uint8__Sequence__init(&msg->value, 0)) {
    file_server2__srv__GetBinaryFile_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  file_server2__srv__GetBinaryFile_Response * msg = (file_server2__srv__GetBinaryFile_Response *)allocator.allocate(sizeof(file_server2__srv__GetBinaryFile_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(file_server2__srv__GetBinaryFile_Response));
  bool success = file_server2__srv__GetBinaryFile_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
file_server2__srv__GetBinaryFile_Response__Sequence__init(file_server2__srv__GetBinaryFile_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  file_server2__srv__GetBinaryFile_Response * data = NULL;

  if (size) {
    data = (file_server2__srv__GetBinaryFile_Response *)allocator.zero_allocate(size, sizeof(file_server2__srv__GetBinaryFile_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = file_server2__srv__GetBinaryFile_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        file_server2__srv__GetBinaryFile_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
file_server2__srv__GetBinaryFile_Response__Sequence__fini(file_server2__srv__GetBinaryFile_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      file_server2__srv__GetBinaryFile_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  file_server2__srv__GetBinaryFile_Response__Sequence * array = (file_server2__srv__GetBinaryFile_Response__Sequence *)allocator.allocate(sizeof(file_server2__srv__GetBinaryFile_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = file_server2__srv__GetBinaryFile_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
file_server2__srv__GetBinaryFile_Response__Sequence__destroy(file_server2__srv__GetBinaryFile_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    file_server2__srv__GetBinaryFile_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
file_server2__srv__GetBinaryFile_Response__Sequence__are_equal(const file_server2__srv__GetBinaryFile_Response__Sequence * lhs, const file_server2__srv__GetBinaryFile_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!file_server2__srv__GetBinaryFile_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  file_server2__srv__GetBinaryFile_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(file_server2__srv__GetBinaryFile_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    file_server2__srv__GetBinaryFile_Response * data =
      (file_server2__srv__GetBinaryFile_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!file_server2__srv__GetBinaryFile_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          file_server2__srv__GetBinaryFile_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!file_server2__srv__GetBinaryFile_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
file_server2__srv__GetBinaryFile_Event__init(file_server2__srv__GetBinaryFile_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    file_server2__srv__GetBinaryFile_Event__fini(msg);
    return false;
  }
  // request
  if (!file_server2__srv__GetBinaryFile_Request__Sequence__init(&msg->request, 0)) {
    file_server2__srv__GetBinaryFile_Event__fini(msg);
    return false;
  }
  // response
  if (!file_server2__srv__GetBinaryFile_Response__Sequence__init(&msg->response, 0)) {
    file_server2__srv__GetBinaryFile_Event__fini(msg);
    return false;
  }
  return true;
...
file_server2__srv__GetBinaryFile_Event__fini(file_server2__srv__GetBinaryFile_Event * msg)
{
  ...
  // request
  file_server2__srv__GetBinaryFile_Request__Sequence__fini(&msg->request);
  // response
  file_server2__srv__GetBinaryFile_Response__Sequence__fini(&msg->response);
}
...
file_server2__srv__GetBinaryFile_Event__are_equal(const file_server2__srv__GetBinaryFile_Event * lhs, const file_server2__srv__GetBinaryFile_Event * rhs)
{
  ...
  // request
  if (!file_server2__srv__GetBinaryFile_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!file_server2__srv__GetBinaryFile_Response__Sequence__are_equal(
  ...
  file_server2__srv__GetBinaryFile_Event * output)
{
  ...
  // request
  if (!file_server2__srv__GetBinaryFile_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!file_server2__srv__GetBinaryFile_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  file_server2__srv__GetBinaryFile_Event * msg = (file_server2__srv__GetBinaryFile_Event *)allocator.allocate(sizeof(file_server2__srv__GetBinaryFile_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(file_server2__srv__GetBinaryFile_Event));
  bool success = file_server2__srv__GetBinaryFile_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
file_server2__srv__GetBinaryFile_Event__Sequence__init(file_server2__srv__GetBinaryFile_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  file_server2__srv__GetBinaryFile_Event * data = NULL;

  if (size) {
    data = (file_server2__srv__GetBinaryFile_Event *)allocator.zero_allocate(size, sizeof(file_server2__srv__GetBinaryFile_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = file_server2__srv__GetBinaryFile_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        file_server2__srv__GetBinaryFile_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
file_server2__srv__GetBinaryFile_Event__Sequence__fini(file_server2__srv__GetBinaryFile_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      file_server2__srv__GetBinaryFile_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  file_server2__srv__GetBinaryFile_Event__Sequence * array = (file_server2__srv__GetBinaryFile_Event__Sequence *)allocator.allocate(sizeof(file_server2__srv__GetBinaryFile_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = file_server2__srv__GetBinaryFile_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
file_server2__srv__GetBinaryFile_Event__Sequence__destroy(file_server2__srv__GetBinaryFile_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    file_server2__srv__GetBinaryFile_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
file_server2__srv__GetBinaryFile_Event__Sequence__are_equal(const file_server2__srv__GetBinaryFile_Event__Sequence * lhs, const file_server2__srv__GetBinaryFile_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!file_server2__srv__GetBinaryFile_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  file_server2__srv__GetBinaryFile_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(file_server2__srv__GetBinaryFile_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    file_server2__srv__GetBinaryFile_Event * data =
      (file_server2__srv__GetBinaryFile_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!file_server2__srv__GetBinaryFile_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          file_server2__srv__GetBinaryFile_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!file_server2__srv__GetBinaryFile_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
